  ...
  const handleFileUpload = (event) => {
    ...
    const validFiles = files.filter((file) => {
      ...
      if (!allowedTypes.includes(file.type)) {
        alert(
          `File ${file.name} is not a supported format (PDF, JPG, PNG only)`
        );
        return false;
      }
          ...
          <div style={styles.previewContent}>
            {file.type.includes("image") ? (
                      ...
                      {pdfPages.map((page) => (
                        <div
                          ...
                          style={{
                            ...styles.pdfPage,
                            display:
                              currentPage === page.pageNum ? "block" : "none",
                          }}
                        >
                            ...
                            <div style={styles.pdfPageBody}>
                              <div style={styles.pdfDocument}>
                                <div style={styles.pdfPlaceholder}>
                                  ...
                                  <div style={styles.pdfText}>{page.text}</div>
                                  <div style={styles.pdfWatermark}>
                                    PDF Document Preview
                                  </div>
                                  <div style={styles.pdfDemoNote}>
                                    In a real application, this would show the
                                    actual PDF content
                                  </div>
                                </div>
                              </div>
                      ...
                      <div style={styles.pdfControls}>
                        <button
                          ...
                          style={{
                            ...
                            ...(currentPage === 1
                              ? styles.pdfControlButtonDisabled
                              : {}),
                          }}
                        >
                          ← Previous
              ...
              <div style={styles.documentPreview}>
                <div style={styles.documentIconLarge}>
    ...
    <div style={styles.verificationAnimation}>
      <div style={styles.animationContainer}>
        ...
        <div style={styles.documentOutline}>
          ...
          >
            {currentStep === "upload" && (
              <div style={styles.animText}>Analyzing Document...</div>
            )}
            {currentStep === "pattern" && (
              <div style={styles.animText}>Checking Patterns...</div>
            )}
            {currentStep === "ai" && (
              <div style={styles.animText}>AI Processing...</div>
            )}
            {currentStep === "results" && (
              <div style={styles.animText}>Compiling Results...</div>
            )}
          </div>
        </div>
      </div>
        ...
        {verificationSteps.map((step, index) => (
          <div
            ...
            style={{
              ...
              (index + 1) * (100 / verificationSteps.length)
      ...
      <div style={{ ...styles.header, ...styles.mobileStack }}>
        <div style={styles.headerContent}>
          ...
          <p style={styles.subtitle}>
            Advanced AI-powered verification for educational and financial
            documents
          </p>
        </div>
          ...
          <div style={styles.section}>
            ...
            {uploadedFiles.length > 0 && (
              <div style={styles.uploadedFiles}>
                <h4 style={styles.uploadedFilesTitle}>
            ...
            <div style={styles.resultsSection}>
              ...
              <div style={styles.resultsGrid}>
                {verificationResults.map((result) => (
                  ...
                  >
                    <div
                      style={{ ...styles.resultHeader, ...styles.mobileStack }}
                    >
                      <div style={styles.resultFileInfo}>
                        ...
                        <div>
                          <div style={styles.resultFileName}>
                            {result.fileName}
                          </div>
                          <div style={styles.resultDate}>
                            Verified:{" "}
                            {result.verificationDate.toLocaleTimeString()}
                          </div>
                        </div>
                      </div>
                      <div
                      ...
                      <div style={styles.metric}>
                        ...
                        <div
                          style={{
                            ...styles.metricValue,
                            color:
                              result.fraudScore > 50 ? "#ef4444" : "#10b981",
                          }}
                        >
                          {result.fraudScore}%
                        </div>
        ...
        <div style={styles.featuresGrid}>
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureDesc}>
              Advanced algorithms detect inconsistencies in document patterns
              and layouts
            </p>
          </div>
          <div style={styles.featureCard}>
          ...
          <div style={styles.featureCard}>
            ...
            <p style={styles.featureDesc}>
              Machine learning models trained on thousands of fraudulent
              documents
            </p>
          </div>
          <div style={styles.featureCard}>
