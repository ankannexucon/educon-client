  ...
  const [data, setData] = useState([
    {
      ...
      status: "pending",
      documents: ["Accreditation Certificate", "Profile Document"],
      notes: "",
    },
    {
      id: 2,
    ...
    >
      ...
      <Box>
        <Typography variant="h4" fontWeight={700} gutterBottom>
          University Registration Review
        </Typography>
        <Typography variant="body2" sx={{ opacity: 0.9 }}>
          Approve or reject universities applying to join the portal
        </Typography>
      </Box>
  ...
  >
    ...
    <DialogContent sx={{ p: 3 }}>
      <DialogContentText sx={{ mb: 3, color: "text.primary" }}>
        {dialogAction === "accepted"
          ? `You are about to accept ${selectedApp?.universityName}.`
          : `You are about to reject ${selectedApp?.universityName}.`}
      </DialogContentText>
      <TextField
        autoFocus
        margin="dense"
        ...
        placeholder="Add any feedback or notes for the university..."
        sx={{
